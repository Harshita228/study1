...
public class RegisterPage {
	...
	public static void main(String[] args) {
		...
		String baseUrl = "D:\\harshita\\Chennai VNV batch\\m4\\ConferenceRegistartion.html";
		//Manage the window
...
//registerPage.testData(expectedHeading,"","",null,registerPage.head,true)
		...
		if(registerPage.testTitle(expectedTitle))
			if(registerPage.testHeading(expectedHeading)){
				...
				if(registerPage.testData(expectedLNameErrorMessage,"Harshita","",registerPage.fname,registerPage.lname,true))
					System.out.println("Last Name Error Message: Test Passed!");
				else
					System.out.println("Last Name Error Message: Test Failed!");
				if(registerPage.testData(expEmailBlankErrMsg,"Ahuja","",registerPage.lname,registerPage.email,true))
				...
				if(registerPage.testData(expContactErrorMsg,"harshita@gmail.com","8898118",registerPage.email,registerPage.contact,true))
